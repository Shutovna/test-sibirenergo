 ...
 * Date: 19.09.2010
 * Time: 14:28:01
 * —ервис дл€ операций с картами
 */
public interface BonusService {
    /**
     * ќпераци€ регистрации покупки и начислени€ баллов
     *
     * @param cardId      номер карты
     * @param pointOfSale место совершени€ операции
     * @param amount      обща€ сумма покупки
     * @param operationId идентификатор операции
     * @return текущий баланс карты
     * @throws OperationAlreadyExistsException
     *          если операци€ с таким идентификатором уже есть
     */
    double award(String cardId, String pointOfSale, Double amount, String operationId) throws OperationAlreadyExistsException;

    /**
     * ќпераци€ получени€ текущего баланса
     *
     * @param cardId номер карты
     * @return текущий баланс карты
